...
*  **Params:**
	...
	**Required:**
	...
	`cost_inc_tax_flg [string]` - Cost Include Tax Flag.
...
* **Success Response:**
	...
	```javascript
	{
		...
		"token":{
			...
			"timestamp":"{ts '2020-09-16 20:50:31'}"
		}
	}
	```
...
* **Sample POST:**
	...
	<form id="postForm" name="postForm" method="POST" action="http://api.tasscloud.com.au/tassweb/api/">
		 <input type="hidden" name="method" value="addPOLine">
