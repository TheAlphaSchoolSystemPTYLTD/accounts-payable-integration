...
* **Error Response:**
    ...
    `invoice_amount` greater than 0.00
    ```javascript
    __invalid: {
    ...
    `invoice_amount` more than 2 decimal points
    ```javascript
    __invalid: {
    ...
    `comment_2` exceed 4000 characters
    ```javascript
    __invalid: {
      "comment_2": "Value exceeds 4000 characters."
    }
    ```
    ...
    `dist_amount` more than 2 decimal points
    ```javascript
    __invalid: {
    ...
    `tax_amount` more than 2 decimal points
    ```javascript
    __invalid: {
